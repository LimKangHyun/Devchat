...
const CommentCard = ({
  ...
  const isGeneralComment = review.diffLine == null;
  ...
  return (
    <div style={{
      ...
      {isGeneralComment && (
        <div style={{
          fontSize: '11px', color: '#b7791f',
          backgroundColor: '#fffbeb', border: '1px solid #fbd38d',
          borderRadius: '4px', padding: '4px 8px',
          marginBottom: '6px', fontFamily: UI_FONT,
        }}>
          ⚠️ diff 변경 범위에서 멀어 GitHub에는 이 줄이 아닌 전체 코멘트로 등록됩니다
        </div>
      )}

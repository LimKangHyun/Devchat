...
import project.api.global.exception.ErrorResponse;
import project.api.global.exception.errorcode.LoginErrorCode;
...
public class FormFailureHandler implements AuthenticationFailureHandler {
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
		...
		response.setStatus(loginErrorCode.getStatus());

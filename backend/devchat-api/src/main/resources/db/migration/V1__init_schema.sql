...
CREATE TABLE `chat_room` (
                             ...
                             `ai_review_enabled` bit(1) NOT NULL,
                             `ai_summary_enabled` bit(1) NOT NULL,
...
CREATE TABLE `ai_review` (
                             ...
                             `completed_files` int NOT NULL,
                             `created_at` datetime(6) DEFAULT NULL,
                             `error_message` varchar(255) DEFAULT NULL,
                             `failed_files` int NOT NULL,
                             `github_published` bit(1) NOT NULL,
                             `pr_body` text,
                             `pr_diff` longtext,
                             `pr_number` int DEFAULT NULL,
                             `pr_status` enum('CLOSED','EDITED','MERGED','OPEN','REOPENED','SYNCHRONIZE') DEFAULT NULL,
                             `pr_title` text,
                             `published_by` varchar(255) DEFAULT NULL,
                             `rag_used` bit(1) NOT NULL,
                             `status` enum('FAIL','PENDING','SKIPPED','SUCCESS') DEFAULT NULL,
                             ...
                             `skipped_files` text,
                             PRIMARY KEY (`id`),
                             KEY `FKanmf4uml4ee6y1fl5a2gmtwmk` (`room_id`),
                             CONSTRAINT `FKanmf4uml4ee6y1fl5a2gmtwmk` FOREIGN KEY (`room_id`) REFERENCES `chat_room` (`room_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `ai_review_comment` (
                                     ...
                                     `comment` text,
                                     `created_at` datetime(6) DEFAULT NULL,
                                     `diff_line` int DEFAULT NULL,
                                     `file_path` varchar(255) DEFAULT NULL,
                                     `line_number` int DEFAULT NULL,
                                     `ai_review_id` bigint DEFAULT NULL,
                                     PRIMARY KEY (`id`),
                                     KEY `FKm6atw11chup4b5ffhxdu3fluj` (`ai_review_id`),
                                     CONSTRAINT `FKm6atw11chup4b5ffhxdu3fluj` FOREIGN KEY (`ai_review_id`) REFERENCES `ai_review` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `ai_comment_mod` (
                                  ...
                                  PRIMARY KEY (`id`),
                                  KEY `FK682fh0m7luyipf03ri964eg5k` (`comment_id`),
                                  CONSTRAINT `FK682fh0m7luyipf03ri964eg5k` FOREIGN KEY (`comment_id`) REFERENCES `ai_review_comment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `chat_message` (
                                ...
                                `type` enum('AI_REVIEW','CODE','EVENT','GIT','IMAGE','TEXT') DEFAULT NULL,
                                `ai_review_id` bigint DEFAULT NULL,
                                ...
                                CONSTRAINT `FKmptl325jjoxxsaudpuy2r0tfo` FOREIGN KEY (`ai_review_id`) REFERENCES `ai_review` (`id`),
...
CREATE TABLE `post` (
                        ...
                        `room_id` bigint DEFAULT NULL,
                        PRIMARY KEY (`post_id`),
                        UNIQUE KEY `UKauwviyd7u9y2wyijjdu9octjc` (`room_id`),

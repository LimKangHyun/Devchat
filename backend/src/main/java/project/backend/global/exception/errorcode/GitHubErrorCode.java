...
public enum GitHubErrorCode implements ErrorCode {
    ...
    INVALID_TOKEN("GE-002", "토큰이 유효하지 않습니다.", HttpStatus.UNAUTHORIZED),
    ...
    WEBHOOK_DELETE_FAILED("GE-008", "웹훅 삭제 중 예상치 못한 예외가 발생했습니다.",
        HttpStatus.INTERNAL_SERVER_ERROR),
    INVALID_PR_ACTION("GE-009", "알 수 없는 PR 액션입니다.", HttpStatus.BAD_REQUEST),
    INVALID_REPO_URL("GE-010", "유효하지 않은 저장소 URL입니다.", HttpStatus.BAD_REQUEST),
    GITHUB_API_FAILED("GE-011", "GitHub API 호출에 실패했습니다.", HttpStatus.BAD_GATEWAY);
